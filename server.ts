    ...
    instructions: [
      ...
      ...(IS_HAIKU_ROUTER
        ? [
            ...
            "",
            "HANDLE DIRECTLY (reply within 5 seconds, NO tool calls except reply/schedule/voice_reply):",
            ...
            "- Simple emoji text responses (in the reply text, not as reactions)",
            ...
            "",
            'ESCALATION PROMPT TEMPLATE: Agent(model: "opus", prompt: "The user in Telegram (chat_id=XXX, message_id=YYY) asked: [TASK]. Research this thoroughly. When done, use the reply MCP tool to send the answer to chat_id=XXX.")',
          ]
        : [
